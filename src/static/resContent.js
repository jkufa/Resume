export const ResContent = {
	...
	experience: {
		...
		content: [
      {
        ...
        bulletPoints: [
          // 'Enhanced & maintained large enterprise Angular/Typescript codebase for Fidelity Digital Assets\' institutional trading platform & internal admin applications, improving performance and stability',
          'Took ownership over complete UI redesign of trading platform within first 5 weeks of joining team, building scalable Sass override architecture to simplify styling 3rd party components & accelerate future development',
          'Built out & championed new shared front end logging library for use across business unit, adding previously non-existent visibility to untracked errors across UIs & enabling better debugging during local development',
          'Developed environment handling service for internal admin app by storing & validating environment data via browser cookies, preventing users from inadvertently making lower environment changes in production',
          'Optimized polling functionality by eliminating hanging subscriptions across admin UI screens, improving user experience & page performance',
        ]
      },
			{
				title: 'Front End Software Engineer',
